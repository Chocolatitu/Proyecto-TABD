...
<?php
        ...
        if($_POST)
        {
            ...
            if (!$conn) {
                ...
                try
                {
                    $plsql = "BEGIN FuncionesHospital.EliminarDoctor('$IdDoctor'); END;";
                    ...
                    $resultado = "<div id=\"Resultado\"><p> Se ha eliminado el doctor correctamente </p></div>";
                    echo $resultado;
                }

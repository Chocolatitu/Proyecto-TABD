...
<body>
    <header>   
        <div class="Cabezera">
            ...
            <h2 class>Añadir Hospital</h2>
        </div>

        <nav class = "nav1">
            <ul class = "nav1_ul1">
                <li class="li"><a href="Hospital.html" class="a">Volver Hospital</a></li>
        ...
        if($_POST)
        {
            ...
            if (!$conn) {
                ...
                if($flag1){
                    ...
                    if($Hospi != 0)
                    {
                        throw new OCIException('El hospital ya existe',501);
                    }
                }
                    ...
                    try
                    {
                        ...
                        $resultado = "<div id=\"Resultado\"><p> Se ha registrado el hospital correctamente </p></div>";
                        echo $resultado;
                    }

...
<body>
    <header>   
        <div class="Cabezera">
            ...
            <h2 class>Eliminar Departamento</h2>
        </div>
...
<?php
        ...
        if($_POST)
        {
            ...
            if (!$conn) {
                ...
                try
                {
                    $plsql = "BEGIN FuncionesHospital.EliminarDepartamento('$IdDpto'); END;";
                    ...
                    $resultado = "<div id=\"Resultado\"><p> Se ha eliminado el departamento correctamente </p></div>";
                    echo $resultado;
                }

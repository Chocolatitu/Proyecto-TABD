...
<?php
        ...
        if($_POST)
        {
            ...
            if (!$conn) {
                ...
                try
                {
                    $plsql = "BEGIN FuncionesHospital.EliminarDiagnostico('$IdCita'); END;";
                    ...
                    $resultado = "<div id=\"Resultado\"><p> Se ha eliminado la cita correctamente </p></div>";
                    echo $resultado;
                }

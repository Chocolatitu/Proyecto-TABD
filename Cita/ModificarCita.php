...
<?php
        ...
        if($_POST)
        {
            ...
            if (!$conn) {
                ...
                try
                {
                    $plsql = "BEGIN FuncionesHospital.ModificarCita('$IdCita', '$Fecha', '$Hora'); END;";
                    ...
                    $resultado = "<div id=\"Resultado\"><p> Se ha modificado la cita correctamente </p></div>";
                    echo $resultado;
                }
